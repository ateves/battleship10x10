...
print("Welcome to Single Player BattleShip by Anthony Teves! Try to find the ship to sink!")

'''this for loop sets the range in place'''
for x in range(0, 10):
  board.append(["O"] * 10)

'''this method is what places the board in a 
way that removes/dismembers all the commas, 
...
def random_row(board_in):
  '''this line of code sets a variable called row and calls it as 
  a range of numbers between 0 and the length of the board in a row'''
...
guess_col = int(input("Guess Column? (1-10) "))-1
